...
@Entity(name="registroPasado")
@Table(name = "registroPasado")
@Getter
@Setter
public class RegistroPasado {
    ...
    public RegistroPasado(String f_entrada, String f_salida, Integer n_personas, tipo_pago t_pago, tipo_pension t_pension,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegistroPasado)) return false;
        RegistroPasado registro = (RegistroPasado) o;
